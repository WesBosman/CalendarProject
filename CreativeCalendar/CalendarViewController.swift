...
//            
//            // Register Class
//            self.calendarView.registerClass(CalendarCell.self, forCellWithReuseIdentifier: cellReuseIdentifier)
//            
//            
//            calendarView.addSubview(self.headerView)
//            calendarView.addSubview(self.calendarView)
//        }
//        
//        
//        
...
//        func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
//            
//            let dayCell = collectionView.dequeueReusableCellWithReuseIdentifier(cellReuseIdentifier, forIndexPath: indexPath) as! CalendarCell
//            
//            let currentMonthInfo : [Int] = monthInfo[indexPath.section]! // we are guaranteed an array by the fact that we reached this line (so unwrap)
//            
//            let fdIndex = currentMonthInfo[FIRST_DAY_INDEX]
